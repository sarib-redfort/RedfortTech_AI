  ...
  React.useEffect(() => {
    ...
    const loadHomepageData = async () => {
      ...
      try {
        ...
        logger.debug('[CMS Homepage GET response]', response.data);
        ...
        logger.error('[CMS] Failed to load homepage data:', error);
        setHomepageLoaded(true);
      }
    };
  ...
  React.useEffect(() => {
    ...
    const loadAboutData = async () => {
      ...
      try {
        ...
        logger.debug('[CMS About GET response]', response.data);
        const payload = response.data?.data ?? response.data ?? null;
        ...
        logger.error('[CMS] Failed to load about data:', error);
        setAboutLoaded(true);
      }
    };
  ...
  React.useEffect(() => {
    const loadServiceOptions = async () => {
      ...
      try {
        ...
        logger.error('[CMS FAQ] Failed to load services for target page:', error);
