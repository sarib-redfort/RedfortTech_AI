...
export default function BlogsView({
  ...
  const onSubmit = async (data: BlogFormValues) => {
    ...
    logger.debug("[BLOGS] FormData entries:", Array.from(formData.entries()));
    const imageEntry = formData.get("image");
    logger.debug("[BLOGS] image field:", imageEntry);
    logger.debug("[BLOGS] image field type:", imageEntry instanceof File ? "File" : typeof imageEntry);

    logger.debug("[BLOGS] Payload ready for backend:", payload);
